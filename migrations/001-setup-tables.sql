...
--HANDLE DATETIME
INSERT INTO APPOINTMENT VALUES(1,'P01','D01','S01',STRFTIME('%d/%m/%Y', '2001-01-13'),STRFTIME('%H:%M', '06:00'),STRFTIME('%H:%M', '10:00'), 'BienHoa','408','Khám răng sâu');
...
DELETE FROM APPOINTMENT; --DELETE ALL ROW FROM TABLE
